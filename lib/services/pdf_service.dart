    ...
    pdf.addPage(
      pw.Page(
        build: (context) => pw.Center(
          child: pw.Column(
            main pw.MainAxisAlignment.center,
            children: [
              pw.Text(farmName, style: pw.TextStyle(fontSize: 40, fontWeight: pw.FontWeight.bold)),
              pw.SizedBox(height: 20),
              pw.Text('Financial Performance Report', style: pw.TextStyle(fontSize: 24)),
              pw.SizedBox(height: 40),
              pw.Text('Owner: $ownerName', style: pw.TextStyle(fontSize: 18)),
              pw.Text('Date: ${DateFormat('MMMM dd, yyyy').format(DateTime.now())}', style: pw.TextStyle(fontSize: 16)),
            ],
          ),
        ),
      ),
      ...
      pw.Page(
        build: (context) => pw.Column(
          ...
          children: [
            ...
            pw.SizedBox(height: 20),
            _buildSummaryRow('Total Profit', CurrencyFormatter.format(summary.totalProfit)),
            _buildSummaryRow('Overall ROI', '${summary.overallROI.toStringAsFixed(1)}%'),
            _buildSummaryRow('Avg. Cost / Chicken', CurrencyFormatter.format(summary.avgCostPerBird)),
            pw.SizedBox(height: 40),
        ...
        pw.Page(
          build: (context) => pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 20),
              _buildSummaryRow('Mortality Summary', '${batch.totalMortality} birds (${batch.mortalityRate.toStringAsFixed(1)}%)'),
              _buildSummaryRow('Total Sold', '${batch.totalSold} birds'),
              _buildSummaryRow('Net Profit', CurrencyFormatter.format(batch.netProfit)),
